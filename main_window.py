...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textBrowser.setGeometry(QtCore.QRect(10, 20, 491, 681))
        ...
        self.btn_designNet = QtWidgets.QPushButton(self.centralwidget)
        self.btn_designNet.setGeometry(QtCore.QRect(550, 340, 131, 28))
        self.btn_designNet.setObjectName("btn_designNet")
        self.btn_model_eval = QtWidgets.QPushButton(self.centralwidget)
        self.btn_model_eval.setGeometry(QtCore.QRect(560, 430, 101, 25))
        self.btn_model_eval.setObjectName("btn_model_eval")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_designNet.setText(_translate("MainWindow", "Design AliNet"))
        self.btn_model_eval.setText(_translate("MainWindow", "Model Eval"))
